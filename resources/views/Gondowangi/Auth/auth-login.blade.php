...
<!-- Start GA -->
<script async src="template//www.googletagmanager.com/gtag/js?id=UA-94034622-3"></script>
{{-- <script>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                  ...
                  <div class="form-group">
                    <div class="d-block">
                      ...
                      <div class="float-right">
                        <a href="templateorgot-password.html" class="text-small">
                          Forgot Password?
                        </a>
                      </div>
                    </div>
            ...
            <div class="mt-5 text-muted text-center">
              Don't have an account? <a href="templateegister.html">Create One</a>
            </div>
          </div>
        </div>
      </div>
